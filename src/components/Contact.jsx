...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-screen bg-[#112D4E] pt-[55rem] md:pt-[30rem] pb-[25rem] '>
        ...
        <form action='https://getform.io/f/02d14b7c-a009-43b7-802d-f6f4acc61a14' method='POST' className='flex flex-col max-w-[600px] w-full '>
          <div>
            ...
            <div className='flex flex-row text-[#F9F7F7] pt-4 my-4'>
              <p>Submit the form below or shoot me a message in <a className='font-bold cursor-pointer ' href='https://www.linkedin.com/in/shuk-han-chau-835057132' target='_blank'> Linkedin </a></p>
            </div>
          </div>
