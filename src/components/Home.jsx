  ...
  return (
    <div name='home' className='w-full h-screen bg-[#112D4E]'>
      ...
      <div className='max-w-1000px mx-auto px-10 flex flex-col justify-center h-full md:ml-[18vw]'>
        ...
        <p className='text-[#e2dfdf] py-4 max-w-[700px]'>I'm passionate about building exceptional applications, love investigating and solving problems and excited about finding solution that fits the most. </p>
